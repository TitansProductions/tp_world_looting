...
1. Fixed an issue when lockpicking player-placed chests, the webhook and a lockpick update was not working when it was related to scenarios (not animations).
